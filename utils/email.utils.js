...
const btn = (text, url) =>
  `<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0;">
    <tr>
      <td align="center" bgcolor="${bg}" style="background-color:${bg};padding:0;">
        <a href="${url}"
           target="_blank"
           ...
           style="display:inline-block;
                  ...
                  border:1px solid ${bg};
                  mso-padding-alt:14px 32px;">${text}</a>
      </td>
    </tr>
  </table>`;
...
export const verifyEmailTemplate = (name, verifyUrl) =>
  layout(
    ...
    h1("Verify Your Email Address") +
      p(`Hi ${name},`) +
      p(
        `Thank you for registering with Tech Mind Academy. To complete your registration and activate your account, please verify your email address by clicking the button below.`,
      ) +
      ...
      small(
        `This link will expire in 24 hours. If you did not create an account with Tech Mind Academy, you can safely ignore this email.`,
      ),
  );
...
export const resetPasswordTemplate = (name, resetUrl) =>
  layout(
    ...
    h1("Password Reset Request") +
      p(`Hi ${name},`) +
      p(
        `We received a request to reset the password for your Tech Mind Academy account. If you made this request, click the button below to choose a new password.`,
      ) +
      ...
      notice(
        `This link will expire in 30 minutes. For your security, this link can only be used once. If you did not request a password reset, no action is required and your password will remain unchanged.`,
        "warning",
      ),
  );
...
export const enrollmentConfirmationTemplate = (
  ...
  layout(
    ...
    h1("Enrollment Confirmed") +
      p(`Hi ${studentName},`) +
      p(
        `Your enrollment has been confirmed and you now have full access to the course. You can start learning right away — your progress is saved automatically as you move through each lesson.`,
      ) +
      infoTable(
      ...
      divider() +
      small(
        `If you have any questions about your enrollment, reply to this email and our team will assist you.`,
      ),
  );

// POST /api/payments/verify  →  creator notification of new sale
export const creatorNewEnrollmentTemplate = (
  creatorName,
  studentName,
  courseTitle,
  dashboardUrl,
  ...
  layout(
    ...
    h1("New Student Enrolled") +
      p(`Hi ${creatorName},`) +
      p(
        `A new student has enrolled in one of your courses. Here are the details:`,
      ) +
      infoTable(
      ...
      p(
        `You can view all enrollments, track student progress, and manage your course from your creator dashboard.`,
      ) +
      btn("Go to Creator Dashboard", dashboardUrl) +
      divider() +
      small(
        `You are receiving this notification because you are a course creator on Tech Mind Academy.`,
      ),
  );
...
export const assignmentGradedTemplate = (
  ...
  layout(
    ...
    h1("Assignment Graded") +
      p(`Hi ${studentName},`) +
      p(
        `Your instructor has reviewed and graded your assignment submission. Here is a summary of your result:`,
      ) +
      infoTable(
      ...
      divider() +
      small(
        `Continue working through your course to complete all assignments and earn your certificate.`,
      ),
  );

// POST /api/assignments/:id/submit  →  creator notified of new submission
export const creatorSubmissionTemplate = (
  creatorName,
  studentName,
  assignmentTitle,
  courseTitle,
  ...
  layout(
    ...
    h1("New Assignment Submission") +
      p(`Hi ${creatorName},`) +
      p(
        `A student has submitted an assignment that is waiting for your review and grading.`,
      ) +
      infoTable(
      ...
      p(
        `Please log in to your dashboard to review the submission, provide feedback, and assign a grade.`,
      ) +
      btn("Review Submission", submissionsUrl) +
      divider() +
      small(
        `Timely feedback helps students improve and stay engaged with your course.`,
      ),
  );
...
export const quizPassedTemplate = (
  ...
  layout(
    ...
    h1("Quiz Passed") +
      p(`Hi ${studentName},`) +
      p(
        `Congratulations on passing your quiz. Here is a summary of your result:`,
      ) +
      metric(
        "Your Score",
        `${scorePercent}%`,
        `The passing mark was ${passMark}%.`,
      ) +
      infoTable(
      ...
      divider() +
      small(
        `Well done. Keep progressing through your course to complete all lessons and earn your certificate.`,
      ),
  );
...
export const courseCompletedTemplate = (studentName, courseTitle, certUrl) =>
  layout(
    `You have completed "${courseTitle}" — your certificate is ready.`,
    h1("Course Completed") +
      p(`Hi ${studentName},`) +
      p(
        `You have successfully completed the course. This is a significant achievement and we hope you found the learning experience valuable.`,
      ) +
      infoTable(
        infoRow("Course", courseTitle, false) +
      ...
      notice(
        `Your certificate of completion has been issued. Download it from your dashboard and add it to your resume or LinkedIn profile to showcase your achievement.`,
        "success",
      ) +
      btn("Download Your Certificate", certUrl) +
      divider() +
      small(
        `Thank you for learning with Tech Mind Academy. We look forward to seeing you in another course.`,
      ),
  );
...
export const contactFormTemplate = (name, email, message) =>
  layout(
    ...
    h1("New Contact Form Message") +
      ...
      small(
        `Reply directly to <a href="mailto:${email}" style="color:#999999;">${email}</a> to respond to this enquiry.`,
      ),
  );
...
export const contactConfirmationTemplate = (name, message) =>
  layout(
    ...
    h1("We Received Your Message") +
      p(`Hi ${name},`) +
      p(
        `Thank you for reaching out to Tech Mind Academy. We have received your message and a member of our team will get back to you within 24 hours during business days.`,
      ) +
      quoteBlock("Your Message", message.replace(/\n/g, "<br/>")) +
      divider() +
      small(
        `If your matter is urgent, you can also reach us directly at <a href="mailto:${process.env.SMTP_USER}" style="color:#999999;">${process.env.SMTP_USER}</a>.`,
      ),
  );
...
export const refundRequestedStudentTemplate = ({
  studentName,
  courseName,
  amountPaid,
  progressPercent,
  ...
  layout(
    ...
    h1("Refund Request Received") +
      p(`Hi ${studentName},`) +
      p(
        `We have received your refund request for the course below. Our team will review your request within 2 business days and you will be notified of the outcome by email.`,
      ) +
      infoTable(
      ...
      notice(
        `Once approved, refunds are processed to the original payment method within 5 to 10 business days. UPI refunds typically arrive within 3 to 5 business days. International cards may take up to 15 business days.`,
        "info",
      ) +
      btn(
        "View My Refund Requests",
        `${process.env.CLIENT_URL}/student/refunds`,
      ) +
      divider() +
      small(
...
export const refundAlertAdminTemplate = ({
  studentName,
  studentEmail,
  courseName,
  amountPaid,
    ...
    h1("New Refund Request — Action Required") +
      ...
      infoTable(
        infoRow("Student Name", studentName, false) +
          infoRow(
            "Student Email",
            `<a href="mailto:${studentEmail}" style="color:#1a1a2e;">${studentEmail}</a>`,
            true,
          ) +
          infoRow("Course", courseName, false) +
          infoRow(
      ...
      divider() +
      small(
        `Log in to the admin panel to approve or reject this request. The student will be notified automatically when a decision is made.`,
      ),
  );

// PATCH /api/refunds/admin/:id/resolve (approve)  →  student approved
export const refundApprovedStudentTemplate = ({
  studentName,
  courseName,
  refundAmount,
  paymentMethod,
  ...
  layout(
    ...
    h1("Refund Approved") +
      p(`Hi ${studentName},`) +
      p(
        `Your refund request has been reviewed and approved. Here are the details of your refund:`,
      ) +
      infoTable(
        infoRow("Course", courseName, false) +
          infoRow(
      ...
      notice(
        `Refunds typically appear in your account within 5 to 10 business days depending on your bank or payment provider. UPI refunds are usually faster at 3 to 5 business days. If you do not see the refund after 15 business days, please contact your bank with the reference number above.`,
        "info",
      ) +
      p(
        `Your access to ${courseName} has been removed as part of the refund process.`,
      ) +
      btn("Explore Other Courses", `${process.env.CLIENT_URL}/courses`) +
      divider() +
      small(
        `Thank you for your patience during the review process. We hope to see you back on Tech Mind Academy.`,
      ),
  );

// PATCH /api/refunds/admin/:id/resolve (reject)  →  student rejected
export const refundRejectedStudentTemplate = ({
  studentName,
  courseName,
  adminNote,
  progressPercent,
  ...
  layout(
    ...
    h1("Refund Request Update") +
      p(`Hi ${studentName},`) +
      p(
        `Thank you for your patience while we reviewed your refund request. After careful consideration, we are unable to process a refund for this course at this time.`,
      ) +
      infoTable(
        infoRow("Course", courseName, false) +
      ...
      notice(
        `If you believe this decision was made in error or have additional information to share, please reply to this email with your request reference number and we will look into your case again.`,
        "warning",
      ) +
      p(
        `Your access to ${courseName} remains fully active. We encourage you to continue with the course.`,
      ) +
      btn("Continue Learning", `${process.env.CLIENT_URL}/student/learn`) +
      divider() +
      small(
        `Our support team is always available to help. Reply to this email if you have any questions.`,
      ),
  );
...
export const internshipAdminTemplate = ({
  name,
  email,
  phone,
  college,
  ...
  layout(
    ...
    h1("New Internship Application") +
      ...
      infoTable(
        infoRow("Full Name", name, false) +
          ...
          (linkedIn
            ? infoRow(
                "LinkedIn",
                `<a href="${linkedIn}" style="color:#1a1a2e;">${linkedIn}</a>`,
                false,
              )
            : "") +
          (github
            ? infoRow(
                "GitHub",
                `<a href="${github}" style="color:#1a1a2e;">${github}</a>`,
                true,
              )
            : "") +
      ...
      divider() +
      small(
        `Log in to the admin panel to review this application and update the status.`,
      ),
  );

// POST /api/internships/:id/apply  →  applicant shortlisted confirmation
export const internshipApplicantTemplate = ({
  name,
  internship,
  application,
}) =>
  layout(
    ...
    h1("Your Application Has Been Received") +
      p(`Hi ${name},`) +
      p(
        `Thank you for applying for the internship position at Tech Mind Academy. We have reviewed your application and are pleased to inform you that you have been shortlisted for the next stage of the process.`,
      ) +
      infoTable(
        infoRow("Position", internship.title, false) +
          infoRow("Company", internship.company, true) +
      ...
      notice(
        `Our team will review your profile in detail and reach out to you within 2 to 3 business days with the next steps. Please keep an eye on this email address for further communication.`,
        "info",
      ) +
      p(
        `Your offer letter is attached to this email. Please download it, sign it, and submit it using the link below.`,
      ) +
      btn(
        "Submit Signed Offer Letter",
        "https://docs.google.com/forms/d/e/1FAIpQLSfOTYuJISYC4225bcVQlyWoCJVbeoUbFF9jkVd2nMUosuCdbg/viewform?usp=publish-editor",
      ) +
      divider() +
      small(
        `If you have any questions, reply to this email with your application reference number and our team will assist you.`,
      ),
  );
...
export const internshipStatusShortlistedTemplate = ({ application }) =>
  layout(
    `You have been shortlisted for ${application.internship.title}.`,
    h1("You Have Been Shortlisted") +
      p(`Hi ${application.name},`) +
      p(
        `We are pleased to inform you that after reviewing your application, you have been shortlisted for the internship position below. Our team will be reaching out to you shortly with the next steps.`,
      ) +
      infoTable(
      ...
      notice(
        `Please ensure that you are available and responsive on this email address. We will contact you within 2 to 3 business days with further details.`,
        "info",
      ) +
      divider() +
      small(
        `If you have any questions, reply to this email with your application reference number.`,
      ),
  );

// PUT /api/internships/applications/:appId/status (rejected)
export const internshipStatusRejectedTemplate = ({ application }) =>
  layout(
    `Update on your application for ${application.internship.title}.`,
    h1("Application Status Update") +
      p(`Hi ${application.name},`) +
      p(
        `Thank you for taking the time to apply for the ${application.internship.title} position at ${application.internship.company} and for your interest in Tech Mind Academy.`,
      ) +
      p(
        `After carefully reviewing all applications, we regret to inform you that we will not be moving forward with your application at this time. This decision was difficult given the number of strong candidates who applied.`,
      ) +
      infoTable(
        infoRow("Position", application.internship.title, false) +
          infoRow("Company", application.internship.company, true) +
      ...
      notice(
        `We encourage you to apply to future internship opportunities that match your skills. We keep all applications on file and may reach out if a suitable position becomes available.`,
        "info",
      ) +
      divider() +
      small(
        `Thank you again for your interest in Tech Mind Academy. We wish you the very best in your career journey.`,
      ),
  );
...
export const certificatePurchaseAdminTemplate = ({
  certOrder,
  certNumber,
  razorpay_order_id,
  razorpay_payment_id,
  ...
  layout(
    ...
    h1("New Certificate Purchase") +
      p(
        `A student has completed payment for a certificate. Please issue the certificate and send it to the student.`,
      ) +
      infoTable(
        infoRow("Student Name", certOrder.name, false) +
          infoRow(
            "Email",
            `<a href="mailto:${certOrder.email}" style="color:#1a1a2e;">${certOrder.email}</a>`,
            true,
          ) +
          ...
          infoRow(
            "Certificate Type",
            certOrder.certificateType.charAt(0).toUpperCase() +
              certOrder.certificateType.slice(1),
            false,
          ) +
      ...
      notice(
        `Please send the issued certificate to the student at ${certOrder.email} as soon as possible.`,
        "warning",
      ) +
      divider() +
      small(
        `This is an automated notification from the Tech Mind Academy payment system.`,
      ),
  );

// POST /api/certificates/verify-payment  →  student payment confirmed
export const certificatePurchaseStudentTemplate = ({
  certOrder,
  certNumber,
  pdfAttached,
}) =>
  layout(
    ...
    h1("Payment Confirmed") +
      p(`Hi ${certOrder.name},`) +
      p(
        `Your payment of Rs. ${certOrder.amount} has been received successfully. Your certificate is now being processed.`,
      ) +
      infoTable(
        infoRow("Course", certOrder.courseName, false) +
          ...
          infoRow(
            "Status",
            statusLabel(
              pdfAttached ? "Issued" : "Processing",
              pdfAttached ? "success" : "warning",
            ),
            false,
          ),
      ) +
      (pdfAttached
        ? p(
            `Your certificate is attached to this email. Download it and save it for your records. You can also add it to your LinkedIn profile or include it in your resume.`,
          )
        : notice(
            `Your certificate will be sent to this email address within 1 to 2 business days. If you do not receive it within that time, please reply to this email with your certificate number above.`,
            "info",
          )) +
      divider() +
      small(
        `Please keep your certificate number for future reference. If you have any questions, reply to this email.`,
      ),
  );

// POST /api/certificates/admin/issue  →  admin manually issued to student
export const certificateAdminIssuedTemplate = ({
  certOrder,
  certNumber,
  certLabel,
}) =>
  layout(
    ...
    h1("Your Certificate Has Been Issued") +
      p(`Hi ${certOrder.name},`) +
      p(
        `Your certificate for completing ${certOrder.courseName} has been issued by Tech Mind Academy and is attached to this email.`,
      ) +
      infoTable(
        infoRow("Course", certOrder.courseName, false) +
      ...
      p(
        `Your certificate is attached to this email as a PDF file. Please download and save it. You can use it on your resume, LinkedIn profile, or share it with potential employers.`,
      ) +
      divider() +
      small(
        `Please keep your certificate number for verification purposes. If you have any questions, reply to this email.`,
      ),
  );
...
export const paymentRefundedTemplate = (
  studentName,
  courseTitle,
  refundAmount,
  razorpayPaymentId,
  ...
  layout(
    ...
    h1("Refund Processed") +
      p(`Hi ${studentName},`) +
      p(
        `A refund has been issued for your purchase of ${courseTitle}. The amount will be returned to your original payment method.`,
      ) +
      infoTable(
        infoRow("Course", courseTitle, false) +
          infoRow(
      ...
      notice(
        `Refunds typically appear in your account within 5 to 10 business days. UPI refunds are usually faster at 3 to 5 business days. International cards may take up to 15 business days. If you do not see the refund after 15 business days, please contact your bank with the payment reference number above.`,
        "info",
      ) +
      p(
        `Your enrollment in ${courseTitle} has been removed as part of this refund.`,
      ) +
      divider() +
      small(
        `If you have any questions about this refund, reply to this email with the payment reference number.`,
      ),
  );
